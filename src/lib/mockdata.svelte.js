...
export let activePersona = new ActivePersona(0)

export const setPersona = i => (activePersona.id = i)
export let bankdata = $state(personas[activePersona.id].data.bankdata)

export let pensionsdata = $state(personas[activePersona.id].data.pensionsdata)

export let försäkringsdata = $state(
  personas[activePersona.id].data.försäkringsdata,
)

export const todos = $state(personas[activePersona.id].data.todos)
